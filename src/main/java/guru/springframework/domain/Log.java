...
public class Log
{
    ...
    {
        return "ClassPojo [spec_info = "+spec_info+", exception = "+exception+", resp_rec_time = "+resp_rec_time+", logger = "+logger+", FROM = "+FROM+", nf_type = "+nf_type+", gpsi = "+gpsi+", pei = "+pei+", dest_ip_port = "+dest_ip_port+", source_ip_port = "+source_ip_port+", id = "+id+", state = "+state+", nf_name = "+nf_name+", nf_instance_id = "+nf_instance_id+", data_detail = "+data_detail+", corr_id = "+corr_id+", snssai = "+snssai+", status_description = "+status_description+", sub_status = "+sub_status+", level = "+level+", session_id = "+session_id+", message = "+message+", supi = "+supi+", log_time = "+log_time+", marker = "+marker+", index_par2 = "+index_par2+", int_instance_id = "+int_instance_id+", index_par3 = "+index_par3+", TO = "+TO+", module_name = "+module_name+", req_sent_time = "+req_sent_time+", index_par1 = "+index_par1+", status = "+status+"]";
    }
}
